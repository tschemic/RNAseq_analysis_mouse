...
go_simple <- simplify(go, cutoff = 0.7)
dim(go_simple)

dplot <- dotplot(go_simple, showCategory =30) + 
...
cplot <- cnetplot(go_simple, showCategory = 20,  foldChange = FC) +
